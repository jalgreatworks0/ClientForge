...
export interface GetContactAnalyticsRequest {
  filters?: AnalyticsFilters
}

export interface GetDealAnalyticsRequest {
  filters?: AnalyticsFilters
  pipelineId?: string
}
...
export interface GetSalesPipelineAnalyticsRequest {
  pipelineId: string
  filters?: AnalyticsFilters
}
...
export interface GetActivityAnalyticsRequest {
  filters?: AnalyticsFilters
}
