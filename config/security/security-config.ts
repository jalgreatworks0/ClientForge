...
export interface SecurityConfig {
  ...
  accountLocking: {
    ...
    lockDurationMs: number // milliseconds
  }
}
...
export function validateSecurityConfig(): void {
  ...
  if (securityConfig.jwt.secret === 'your-super-secret-jwt-key-change-this-in-production') {
  ...
  if (securityConfig.session.secret.length < 32) {
